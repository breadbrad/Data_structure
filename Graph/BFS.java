public clas BreadthFirstSearch {
        /** post: The array parent wil conatain the predecessor
        ...
        */
        ...
        public static int[] breadthFirstSearch(Graph graph, int start) {
                ...
                // Declare array identified and  initial its elements to false 
                boolean[] identified = new boolean[graph.getNumV];
                /** Mart the start vertex as identified and insert it into the queue */
